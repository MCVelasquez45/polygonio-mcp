 ...
 */
async function runCreditSpreadBacktest(input: FuturesBacktestInput, barsResponse: any) {
...
export async function runStressTest(input: FuturesBacktestInput, scenarios?: StressScenario[]) {
...
export async function runFuturesBacktest(input: FuturesBacktestInput) {
  ...
  if (isCreditSpreadStrategy(params)) {
    ...
    return runCreditSpreadBacktest(input, barsResponse);
  }
