...
const structuredStrategySchema = new Schema(
  {
    ...
    tradingMethod: { type: String, enum: ['equities', 'options', 'futures'] },
    contractSelection: { type: Schema.Types.Mixed },
    spreadConfig: { type: Schema.Types.Mixed },
    regimeConfig: { type: Schema.Types.Mixed },
    timeRules: { type: Schema.Types.Mixed },
...
export const StrategyVersionModel =
  mongoose.models.PipelineVersion || mongoose.model<StrategyVersionDocument>('PipelineVersion', StrategyVersionSchema);
